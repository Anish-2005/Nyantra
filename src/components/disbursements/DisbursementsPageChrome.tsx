...
import { ParticlesCanvas } from '@/components/backgrounds';

/**
 * Page-level chrome: Three.js particle canvas + theme variable declarations.
 * Extracted verbatim from the legacy disbursements page.
 */
export function DisbursementsPageChrome() {
  return (
    <>
      <ParticlesCanvas id="disbursements-three-canvas" />
      <style jsx global>{`
        [data-theme="dark"] {

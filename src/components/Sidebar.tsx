              ...
              <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-2">
                {items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <item.icon className={`w-6 h-6 flex-shrink-0 mr-4 ${isActive ? 'text-white' : 'theme-text-muted group-hover:theme-text-primary'}`} />
              ...
              <div key={item.id} className="relative group/tooltip">
                <button
                  ...
                  className={`relative flex items-center transition-all duration-200 group overflow-hidden ${collapsed
                    ...
                    : 'w-full py-3.5 px-4 rounded-xl space-x-3 mb-1'
                      ...
                      ? 'bg-transparent' // We use the absolute div for background
                ...
                >
                  ...
                  <div className={`relative z-10 flex items-center justify-center transition-transform duration-300 ${isActive ? 'scale-110' : 'group-hover:scale-110'}`}>
                    <item.icon className={`w-6 h-6 flex-shrink-0 transition-colors duration-200 ${isActive ? 'text-white' : 'theme-text-secondary group-hover:theme-text-primary'}`} />

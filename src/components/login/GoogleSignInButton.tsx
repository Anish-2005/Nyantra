...
export const GoogleSignInButton = ({ onClick, isLoading, t, className = '' }: GoogleSignInButtonProps) => {
  return (
    <button
      onClick={onClick}
      disabled={isLoading}
      className={`w-full py-2 rounded-lg border theme-border-glass theme-bg-glass flex items-center justify-center gap-2 hover:shadow-md transition-all disabled:opacity-50 ${className}`}
    >
